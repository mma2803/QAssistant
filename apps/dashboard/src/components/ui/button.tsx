...
/**
 * forwardRef is required on React 18: Radix `asChild` triggers (DropdownMenu,
 * Sheet, Dialog, Tooltip) clone this element and pass a ref to anchor/position
 * their popovers. A plain function component would drop that ref and the menus
 * would open unanchored (off-screen) — see the Sessions/Users action menus.
 */
