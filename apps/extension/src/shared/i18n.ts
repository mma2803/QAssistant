...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'start.description.placeholder': 'What are you testing?',
    'start.screenshot.label': 'Capture screenshots',
    'start.hint':
      'Describe what you are testing. Screenshots default to the project setting; override per session here.',
    'start.submit': 'Start recording',
    'start.starting': 'Starting...',
    'start.error.context': 'Enter a non-empty description',
  ...
  fr: {
    ...
    'start.description.label': 'Description',
    'start.description.placeholder': 'Que testez-vous ?',
    'start.screenshot.label': "Capturer des captures d'écran",
    'start.hint':
      "Décrivez ce que vous testez. Les captures d'écran suivent le paramètre du projet ; modifiable par session ici.",
    'start.submit': "Démarrer l'enregistrement",
    'start.starting': 'Démarrage...',
    'start.error.context': 'Saisissez une description non vide',
